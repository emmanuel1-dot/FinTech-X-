...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
  <div class="bg-white p-6 rounded-lg shadow-lg flex items-center justify-between">
    <div>
      <p class="text-gray-500">All users</p>
  ...
  <div class="bg-white p-6 rounded-lg shadow-lg flex items-center justify-between">
    <div>
      <p class="text-gray-500">New registration</p>
...
<div class="bg-white p-6 rounded-lg shadow-lg mb-6">
  ...
  <form class="grid grid-cols-1 md:grid-cols-2 gap-4">
    <input type="text" placeholder="Name" class="p-3 border border-gray-300 rounded-lg">
    <input type="text" placeholder="firstname" class="p-3 border border-gray-300 rounded-lg">
    <input type="email" placeholder="Email" class="p-3 border border-gray-300 rounded-lg">
    <input type="tel" placeholder="Phone number" class="p-3 border border-gray-300 rounded-lg">
    ...
    <textarea placeholder="Adress" class="p-3 border border-gray-300 rounded-lg col-span-2"></textarea>
